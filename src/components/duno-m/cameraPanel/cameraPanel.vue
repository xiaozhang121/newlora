        ...
        <template  v-if="panelType == 'first'">
            ...
            <div class="cameraMain">
                ...
                <div class="btnList" style="padding-bottom: 0; ">
                    ...
                    <div class="row">
                        <div class="btn" :class="{'active':activeNum == 1}" :style="'background:url('+ xjBtn +');'" @mousedown="viewCamera(1, false)" @mouseup="viewCamera(0, true)"></div>
                        <div class="btn" :class="{'actived':activeNum == 2}" :style="'background:url('+ squera +'); transform: rotate(90deg);'" @mousedown="viewCamera(2, false)"  @mouseup="viewCamera(0, true)"></div>
                        <div class="btn"  :class="{'active':activeNum == 3}" :style="'background:url('+ xjBtn +'); transform: rotate(90deg);'" @mousedown="viewCamera(3, false)"   @mouseup="viewCamera(0, true)"></div>
                    </div>
                    <div class="row">
                        <div class="btn" :class="{'actived':activeNum == 4}" :style="'background:url('+ squera +')'"  @mousedown="viewCamera(4, false)" @mouseup="viewCamera(0, true)"></div>
                        <div class="btn" style="visibility: hidden"></div>
                        <div class="btn"  :class="{'actived':activeNum == 5}" :style="'background:url('+ squera +');transform: rotate(180deg);position: relative;'" @mousedown="viewCamera(5, false)" @mouseup="viewCamera(0, true)"></div>
                    </div>
                    <div class="row">
                        <div class="btn"  :class="{'active':activeNum == 6}" :style="'background:url('+ xjBtn +'); transform: rotate(270deg);'" @mousedown="viewCamera(6, false)" @mouseup="viewCamera(0, true)"></div>
                        <div class="btn" :class="{'actived':activeNum == 7}" :style="'background:url('+ squera +');transform: rotate(270deg);'" @mousedown="viewCamera(7, false)" @mouseup="viewCamera(0, true)"></div>
                        <div class="btn" :class="{'active':activeNum == 8}"  :style="'background:url('+ xjBtn +'); transform: rotate(180deg);'" @mousedown="viewCamera(8, false)" @mouseup="viewCamera(0, true)"></div>
                    </div>
