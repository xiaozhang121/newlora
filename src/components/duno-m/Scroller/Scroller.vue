<template>
    <div class="Scroller">
        <div class="wrap" v-show="wrapShow">
            <div id="box">
                <div id="marquee">
                    <div class="marquee_item"  v-for="(item, index) in lists" :key="index"  @mouseenter="enter()" @mouseleave="leave()">
                        <div class="name" :class="[{'commonly':item.alarmLevel == 1},{'serious':item.alarmLevel == 2},{'danger':item.alarmLevel == 3}]">
                            {{ item['alarmLevelName'] }}
                        </div>
                        <div class="time">
                            {{ item['alarmTime'] }}
...
<style lang="scss">
    .Scroller{
        ...
        .marquee_item, .node_item{
            ...
            .time,.mainDevice,.powerDeviceName,.nr{
                margin-right: 20px;
            }
        }
        #node {
