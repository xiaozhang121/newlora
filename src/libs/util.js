...
export const getMonthData = (year, month) => {
  ...
  let stal = month > 9 ? month : '0' + month
  let obj = {
    "startTime": year + String(stal) + "01",
    "day": curMonthDays
  }
  return obj
}
 ...
 *   获取本年/季度有多少天      （年，季度）
 */
export const getQuarter = (year, month) => {   // 年，季度
  year = Number(year)
  month = Number(month)
  let obj
  if(!month){
    ...
    let num1 = stal + 1
    let num2 = stal + 2
    let curMonthDays1 = new Date(year, stal, 0).getDate()
    let curMonthDays2 = new Date(year, num1, 0).getDate()
    let curMonthDays3 = new Date(year, num2, 0).getDate()
    let curMonthDays = curMonthDays1 + curMonthDays2 + curMonthDays3
    // console.log(year+"年"+ stal+"月份共计："+ curMonthDays1 +"天")
    // console.log(year+"年"+ num1 + "月份共计："+ curMonthDays2 + "天")
    // console.log(year+"年"+ num2 +"月份共计："+ curMonthDays3 + "天")
    stal = stal < 10 ? "0" + stal : stal
    // console.log(year+"年"+ "第"+ month +"季度"+ year + String(stal) + "01")
    // console.log("本季度共有："+curMonthDays + "天")
    obj = {
      "startTime": year + String(stal) + "01",
      "day": curMonthDays
    }
...
export const getBreadCrumbList = (routeMetched, homeRoute) => {
  ...
  res = res.filter(item => {
    return !item.meta.hideInMenu || item.meta.isDetails
  })
  return [...res]
}
...
export const getFormat = ()=>{
    return sessionStorage.getItem('format')?sessionStorage.getItem('format'):1
}
