...
export default {
  ...
  data() {
    ...
    return {
      ...
      mixinViewModuleOptions: {
        ...
        getDataListURL: "/lenovo-robot-indoor/rest/reportDetail",
        exportURL:"/lenovo-robot-indoor/rest/reportDownload"
      },
  ...
  methods: {
    ...
    initDataD() {
      postAxiosData("/lenovo-robot-indoor/rest/taskCurLink", {
    ...
    psotAlarmData(row, type, No) {
      const that = this;
      const url = "/lenovo-robot-indoor/rest/manualJudge";
      let oldLevel;
      if (row.warnLevel == "1") {
        oldLevel = "一般";
    ...
    getType() {
      const that = this;
      const url = "/lenovo-robot-indoor/rest/reportDetailDevices";
