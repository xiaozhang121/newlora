<template>
  <div class="abnormalInfo">
    ...
    <wraning :visible="visible" warningID="20190711002" :alarmFileAddress="popData.alarmFileAddress || ''" :judgeResult="popData.alarmContent || ''" :origin="popData.monitorDeviceId" :handleResult="popData.dealRecord || ''" @handleClose="handleClose" />
  </div>
</template>
