    ...
    return {
        ...
        columns: [
            ...
            },
            {
                ...
                render: (h, params) => {
                    let newArr = []
                    newArr.push([h('a', { class:'table_link',props: { type: 'text' },  on: { click: () => { alert('') } } }, '可见光摄像头ID')])
                    return h('div', {
                        class: {
                            member_operate_div: true
                        }
            ...
            },
            {
                ...
                render: (h, params) => {
                    let newArr = []
                    newArr.push([h('el-button', {class:'table_link', style:{ marginRight: '20px'  }, props: { type: 'text' },  on: { click: () => { alert('') } } }, '复归')])
                    newArr.push([h('i', {class:'iconfont icon-daochu',style:{ cursor: 'pointer', position:'relative', top:'0.2px'  }, props: { type: 'text' },  on: { click: () => { alert('') } } }, )])
                    return h('div', {
                        class: "flexPos"
                    }, newArr)
                }
