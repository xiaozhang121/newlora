    ...
    <duno-main   v-if="kilovoltKind == 'all'">
      <div class="main_ctx" ref="firstElE">
        ...
        <div :class="['allShowPic']" v-else-if="isDiagram == 1">
          ...
          <gis-map mapUrl="http://10.0.10.45:8083" @on-alarm="onAlarmC" @on-drag="drag" ref="gisMapObj" :powerPointList="disgramList" @toDetail="toDevice"  :isDiagram="isDiagram" :deviceList="deviceList"></gis-map>
        </div>
        <gis-map @on-alarm="onAlarmC" @on-drag="drag" ref="gisMapObj" :powerPointList="powerPointList" @toDetail="toDevice" mapUrl="http://10.0.10.45:8085" :isDiagram="isDiagram" :deviceList="deviceList"  v-if="isDiagram == 3"></gis-map>
      </div>
    ...
    <duno-main class="kilovolt" v-else-if="kilovoltKind == '1000'">
      <div :class="['item_ctx']"  ref="firstElE"  v-if="isDiagram==1">
        <div>
          ...
          <gis-map mapUrl="http://10.0.10.45:8083/" :kind="1000" @on-alarm="onAlarmC" @on-drag="drag" ref="gisMapObj" :powerPointList="disgramList" @toDetail="toDevice" v-if="isDiagram == 1"  :isDiagram="isDiagram" :deviceList="deviceList"></gis-map>
        </div>
        <!--   <i class="fullScreen iconfont icon-quanping" v-if="!isFullscreen" @click="changeFullScreen($refs.firstElE)"></i>
           <i class="fullScreen iconfont icon-suoxiao" v-else @click="changeFullScreen($refs.firstElE)"></i>-->
      </div>
      ...
      <div :class="['item_ctx']"  ref="firstElE" v-else-if="isDiagram == 3">
        <div>
          <div>
            ...
            <gis-map ref="gisMapObj" @on-drag="drag" :powerPointList="powerPointList" mapUrl="http://10.0.10.45:8085"  @toDetail="toDevice" :kind="1000" :isDiagram="isDiagram" :deviceList="kilovolt1000Pic"></gis-map>
          </div>
       </div>
         <!-- <i class="fullScreen iconfont icon-quanping" v-if="!isFullscreen" @click="changeFullScreen($refs.secondElE)"></i>
         <i class="fullScreen iconfont icon-suoxiao" v-else @click="changeFullScreen($refs.secondElE)"></i>-->
    ...
    <duno-main class="kilovolt" v-else-if="kilovoltKind == '500'">
      <div :class="['item_ctx']" ref="firstElE"  v-if="isDiagram==1">
        <div>
          ...
          <gis-map mapUrl="http://10.0.10.45:8083/" :kind="500" @on-alarm="onAlarmC" @on-drag="drag" ref="gisMapObj" :powerPointList="disgramList" @toDetail="toDevice" v-if="isDiagram == 1"  :isDiagram="isDiagram" :deviceList="deviceList"></gis-map>
        </div>
        <!--  <i class="fullScreen iconfont icon-quanping" v-if="!isFullscreen" @click="changeFullScreen($refs.firstElE)"></i>
          <i class="fullScreen iconfont icon-suoxiao" v-else @click="changeFullScreen($refs.firstElE)"></i>-->
      </div>
      ...
      <div :class="['item_ctx']" ref="firstElE" v-if="isDiagram == 3">
        <div>
          <div>
            ...
            <gis-map ref="gisMapObj" @on-drag="drag"  :powerPointList="powerPointList" mapUrl="http://10.0.10.45:8085" @toDetail="toDevice" :kind="500" :isDiagram="isDiagram" :deviceList="kilovolt500Pic"></gis-map>
            <!--    <i class="fullScreen iconfont icon-quanping" v-if="!isFullscreen" @click="changeFullScreen($refs.secondElE)"></i>
                <i class="fullScreen iconfont icon-suoxiao" v-else @click="changeFullScreen($refs.secondElE)"></i>-->
          </div>
        </div>
    ...
    <duno-main class="kilovolt" v-else-if="kilovoltKind == '220'">
      <div :class="['item_ctx']"  ref="firstElE"  v-if="isDiagram==1">
        <div>
          ...
          <gis-map mapUrl="http://10.0.10.45:8083/" :kind="220" @on-alarm="onAlarmC" @on-drag="drag" ref="gisMapObj" :powerPointList="disgramList" @toDetail="toDevice" v-if="isDiagram == 1"  :isDiagram="isDiagram" :deviceList="deviceList"></gis-map>
        </div>
        <!--   <i class="fullScreen iconfont icon-quanping" v-if="!isFullscreen" @click="changeFullScreen($refs.firstElE)"></i>
           <i class="fullScreen iconfont icon-suoxiao" v-else @click="changeFullScreen($refs.firstElE)"></i>-->
      </div>
      ...
      <div :class="['item_ctx']" ref="firstElE"   v-else-if="isDiagram == 3">
        <div>
          <div>
            ...
            <gis-map ref="gisMapObj" @on-drag="drag" :powerPointList="powerPointList" mapUrl="http://10.0.10.45:8085" @toDetail="toDevice" :kind="220" :isDiagram="isDiagram" :deviceList="kilovolt220Pic"  v-if="isDiagram == 3"></gis-map>
            <!-- <i class="fullScreen iconfont icon-quanping" v-if="!isFullscreen" @click="changeFullScreen($refs.secondElE)"></i>
             <i class="fullScreen iconfont icon-suoxiao" v-else @click="changeFullScreen($refs.secondElE)"></i>-->
          </div>
        </div>
    ...
    <duno-main class="kilovolt" v-else-if="kilovoltKind == '110'">
      <div :class="['item_ctx']" ref="firstElE"  v-if="isDiagram==1">
        <div>
          ...
          <gis-map mapUrl="http://10.0.10.45:8083/" :kind="110" @on-alarm="onAlarmC" @on-drag="drag" ref="gisMapObj" :powerPointList="disgramList" @toDetail="toDevice" v-if="isDiagram == 1"  :isDiagram="isDiagram" :deviceList="deviceList"></gis-map>
        </div>
        <!--      <i class="fullScreen iconfont icon-quanping" v-if="!isFullscreen" @click="changeFullScreen($refs.firstElE)"></i>
              <i class="fullScreen iconfont icon-suoxiao" v-else @click="changeFullScreen($refs.firstElE)"></i>-->
      </div>
      ...
      <div :class="['item_ctx']" ref="firstElE" v-else-if="isDiagram == 3">
        <div>
          <div>
            ...
            <gis-map ref="gisMapObj" @on-drag="drag" :powerPointList="powerPointList" mapUrl="http://10.0.10.45:8085" @toDetail="toDevice" :kind="110" :isDiagram="isDiagram" :deviceList="kilovolt110Pic"  v-if="isDiagram == 3"></gis-map>
            <!--   <i class="fullScreen iconfont icon-quanping" v-if="!isFullscreen" @click="changeFullScreen($refs.secondElE)"></i>
               <i class="fullScreen iconfont icon-suoxiao" v-else @click="changeFullScreen($refs.secondElE)"></i>-->
          </div>
        </div>
      ...
      <duno-main class="kilovolt" v-else-if="kilovoltKind == '35'">
        <div :class="['item_ctx']" ref="firstElE"  v-if="isDiagram==1">
          <div>
            ...
            <gis-map mapUrl="http://10.0.10.45:8083/" :kind="35" @on-alarm="onAlarmC" @on-drag="drag" ref="gisMapObj" :powerPointList="disgramList" @toDetail="toDevice" v-if="isDiagram == 1"  :isDiagram="isDiagram" :deviceList="deviceList"></gis-map>
            <!--      <i class="fullScreen iconfont icon-quanping" v-if="!isFullscreen" @click="changeFullScreen($refs.firstElE)"></i>
                  <i class="fullScreen iconfont icon-suoxiao" v-else @click="changeFullScreen($refs.firstElE)"></i>-->
          ...
          <div>
            <div>
              <div>
                ...
                <gis-map ref="gisMapObj" @on-drag="drag" :powerPointList="powerPointList" mapUrl="http://10.0.10.45:8085" @toDetail="toDevice" :kind="35" :isDiagram="isDiagram" :deviceList="kilovolt35Pic"  v-if="isDiagram == 3"></gis-map>
                <!--   <i class="fullScreen iconfont icon-quanping" v-if="!isFullscreen" @click="changeFullScreen($refs.secondElE)"></i>
                   <i class="fullScreen iconfont icon-suoxiao" v-else @click="changeFullScreen($refs.secondElE)"></i>-->
    ...
    <duno-main class="kilovolt" v-else-if="kilovoltKind == '10'">
      <div :class="['item_ctx']" ref="firstElE"  v-if="isDiagram==1">
        <div>
          ...
          <gis-map mapUrl="http://10.0.10.45:8083/" :kind="10" @on-alarm="onAlarmC" @on-drag="drag" ref="gisMapObj" :powerPointList="disgramList" @toDetail="toDevice" v-if="isDiagram == 1"  :isDiagram="isDiagram" :deviceList="deviceList"></gis-map>
        </div>
        <!--  <drappable class="drappable_assembly" width="1900px" height="675px">
            <div class="allShowPic">
