    ...
    <div class="mainList" v-if="mainlistShow">
      <duno-main   v-if="kilovoltKind == 'all'" :class="{'dunoMainContain': isDiagram==1}">
        <div class="main_ctx" ref="firstElE">
          ...
          <img v-if="showWeather && isDiagram!=1" id="weatherCheck" class="weatherCheck" draggable="true" @dragstart="drag($event, {'src':weatherCheck,'name':'weatherCheck'})"  :src="weatherCheck" style="width: 40px; height: 40px;zIndex:1!important"/>
          ...
          <div :class="['allShowPic']" v-else-if="isDiagram == 1">
            ...
            <gis-map fillColor="#1d2026" mapUrl="http://10.0.10.35:8203" @on-alarm="onAlarmC" @on-drag="drag" ref="gisMapObj" :powerPointList="disgramList" @toDetail="toDevice"  :isDiagram="isDiagram" :deviceList="deviceList"></gis-map>
          </div>
          <gis-map @on-alarm="onAlarmC" @on-drag="drag" ref="gisMapObj" :powerPointList="powerPointListB" @toDetail="toDevice" mapUrl="http://10.0.10.35:8202" :isDiagram="isDiagram" :deviceList="deviceList"  v-if="isDiagram == 3"></gis-map>
        </div>
      ...
      <duno-main class="kilovolt" :class="{dunoMainContain: isDiagram==1}" v-else-if="kilovoltKind == '1000'">
        <div :class="['item_ctx']"  ref="firstElE"  v-if="isDiagram==1">
          <div>
            ...
            <!--<img v-if="showWeather" id="weatherCheck" class="weatherCheck" draggable="true" @dragstart="drag($event, {'src':weatherCheck,'name':'weatherCheck'})"  :src="weatherCheck" style="width: 40px; height: 40px;zIndex:1!important"/>-->
            ...
            <gis-map fillColor="#1d2026" mapUrl="http://10.0.10.35:8204" :kind="1000" @on-alarm="onAlarmC" @on-drag="drag" ref="gisMapObj" :powerPointList="disgramList" @toDetail="toDevice" v-if="isDiagram == 1"  :isDiagram="isDiagram" :deviceList="deviceList"></gis-map>
          </div>
          <!--   <i class="fullScreen iconfont icon-quanping" v-if="!isFullscreen" @click="changeFullScreen($refs.firstElE)"></i>
             <i class="fullScreen iconfont icon-suoxiao" v-else @click="changeFullScreen($refs.firstElE)"></i>-->
        </div>
        ...
        <div :class="['item_ctx']"  ref="firstElE" v-else-if="isDiagram == 3">
          <div>
            <div>
              ...
              <gis-map ref="gisMapObj" @on-drag="drag" :powerPointList="powerPointListB" mapUrl="http://10.0.10.35:8202"  @toDetail="toDevice" :kind="1000" :isDiagram="isDiagram" :deviceList="kilovolt1000Pic"></gis-map>
            </div>
          </div>
          <!-- <i class="fullScreen iconfont icon-quanping" v-if="!isFullscreen" @click="changeFullScreen($refs.secondElE)"></i>
          <i class="fullScreen iconfont icon-suoxiao" v-else @click="changeFullScreen($refs.secondElE)"></i>-->
      ...
      <duno-main class="kilovolt" :class="{'dunoMainContain': isDiagram==1}" v-else-if="kilovoltKind == '500'">
        <div :class="['item_ctx']" ref="firstElE"  v-if="isDiagram==1">
          <div>
            ...
            <gis-map fillColor="#1d2026" mapUrl="http://10.0.10.35:8204" :kind="500" @on-alarm="onAlarmC" @on-drag="drag" ref="gisMapObj" :powerPointList="disgramList" @toDetail="toDevice" v-if="isDiagram == 1"  :isDiagram="isDiagram" :deviceList="deviceList"></gis-map>
          </div>
          <!--  <i class="fullScreen iconfont icon-quanping" v-if="!isFullscreen" @click="changeFullScreen($refs.firstElE)"></i>
            <i class="fullScreen iconfont icon-suoxiao" v-else @click="changeFullScreen($refs.firstElE)"></i>-->
        </div>
        ...
        <div :class="['item_ctx']" ref="firstElE" v-if="isDiagram == 3">
          <div>
            <div>
              ...
              <gis-map ref="gisMapObj" @on-drag="drag"  :powerPointList="powerPointListB" mapUrl="http://10.0.10.35:8202" @toDetail="toDevice" :kind="500" :isDiagram="isDiagram" :deviceList="kilovolt500Pic"></gis-map>
              <!--    <i class="fullScreen iconfont icon-quanping" v-if="!isFullscreen" @click="changeFullScreen($refs.secondElE)"></i>
                  <i class="fullScreen iconfont icon-suoxiao" v-else @click="changeFullScreen($refs.secondElE)"></i>-->
            </div>
          </div>
      ...
      <duno-main class="kilovolt" :class="{'dunoMainContain': isDiagram==1}" v-else-if="kilovoltKind == '220'">
        <div :class="['item_ctx']"  ref="firstElE"  v-if="isDiagram==1">
          <div>
            ...
            <gis-map fillColor="#1d2026" mapUrl="http://10.0.10.35:8204" :kind="220" @on-alarm="onAlarmC" @on-drag="drag" ref="gisMapObj" :powerPointList="disgramList" @toDetail="toDevice" v-if="isDiagram == 1"  :isDiagram="isDiagram" :deviceList="deviceList"></gis-map>
          </div>
          <!--   <i class="fullScreen iconfont icon-quanping" v-if="!isFullscreen" @click="changeFullScreen($refs.firstElE)"></i>
             <i class="fullScreen iconfont icon-suoxiao" v-else @click="changeFullScreen($refs.firstElE)"></i>-->
        </div>
        ...
        <div :class="['item_ctx']" ref="firstElE"   v-else-if="isDiagram == 3">
          <div>
            <div>
              ...
              <gis-map ref="gisMapObj" @on-drag="drag" :powerPointList="powerPointListB" mapUrl="http://10.0.10.35:8202" @toDetail="toDevice" :kind="220" :isDiagram="isDiagram" :deviceList="kilovolt220Pic"  v-if="isDiagram == 3"></gis-map>
              <!-- <i class="fullScreen iconfont icon-quanping" v-if="!isFullscreen" @click="changeFullScreen($refs.secondElE)"></i>
               <i class="fullScreen iconfont icon-suoxiao" v-else @click="changeFullScreen($refs.secondElE)"></i>-->
            </div>
          </div>
      ...
      <duno-main class="kilovolt" :class="{'dunoMainContain': isDiagram==1}" v-else-if="kilovoltKind == '110'">
        <div :class="['item_ctx']" ref="firstElE"  v-if="isDiagram==1">
          <div>
            ...
            <gis-map fillColor="#1d2026" mapUrl="http://10.0.10.35:8204" :kind="110" @on-alarm="onAlarmC" @on-drag="drag" ref="gisMapObj" :powerPointList="disgramList" @toDetail="toDevice" v-if="isDiagram == 1"  :isDiagram="isDiagram" :deviceList="deviceList"></gis-map>
          </div>
          <!--      <i class="fullScreen iconfont icon-quanping" v-if="!isFullscreen" @click="changeFullScreen($refs.firstElE)"></i>
                <i class="fullScreen iconfont icon-suoxiao" v-else @click="changeFullScreen($refs.firstElE)"></i>-->
        </div>
        ...
        <div :class="['item_ctx']" ref="firstElE" v-else-if="isDiagram == 3">
          <div>
            <div>
              ...
              <gis-map ref="gisMapObj" @on-drag="drag" :powerPointList="powerPointListB" mapUrl="http://10.0.10.35:8202" @toDetail="toDevice" :kind="110" :isDiagram="isDiagram" :deviceList="kilovolt110Pic"  v-if="isDiagram == 3"></gis-map>
              <!--   <i class="fullScreen iconfont icon-quanping" v-if="!isFullscreen" @click="changeFullScreen($refs.secondElE)"></i>
                 <i class="fullScreen iconfont icon-suoxiao" v-else @click="changeFullScreen($refs.secondElE)"></i>-->
            </div>
          </div>
      ...
      <duno-main class="kilovolt" :class="{'dunoMainContain': isDiagram==1}" v-else-if="kilovoltKind == '35'">
        <div :class="['item_ctx']" ref="firstElE"  v-if="isDiagram==1">
          <div>
            ...
            <gis-map fillColor="#1d2026" mapUrl="http://10.0.10.35:8204" :kind="35" @on-alarm="onAlarmC" @on-drag="drag" ref="gisMapObj" :powerPointList="disgramList" @toDetail="toDevice" v-if="isDiagram == 1"  :isDiagram="isDiagram" :deviceList="deviceList"></gis-map>
            <!--      <i class="fullScreen iconfont icon-quanping" v-if="!isFullscreen" @click="changeFullScreen($refs.firstElE)"></i>
                  <i class="fullScreen iconfont icon-suoxiao" v-else @click="changeFullScreen($refs.firstElE)"></i>-->
          ...
          <div>
            <div>
              <div>
                ...
                <gis-map ref="gisMapObj" @on-drag="drag" :powerPointList="powerPointListB" mapUrl="http://10.0.10.35:8202" @toDetail="toDevice" :kind="35" :isDiagram="isDiagram" :deviceList="kilovolt35Pic"  v-if="isDiagram == 3"></gis-map>
                <!--   <i class="fullScreen iconfont icon-quanping" v-if="!isFullscreen" @click="changeFullScreen($refs.secondElE)"></i>
                   <i class="fullScreen iconfont icon-suoxiao" v-else @click="changeFullScreen($refs.secondElE)"></i>-->
...
<script>
    ...
    export default {
        ...
        //   },
            ...
            onAlarm(now){
                if((now['powerDeviceId']  && isAlarmMap(this.$store.state.user.alarmConfig, now)) || this.$store.state.user.popPanel){
                    try{
                        this.$refs.gisMapObj.clearAlarm()
                    }catch (e) {}
                    try{
                ...
                if(isAlarmVisible(this.$store.state.user.alarmConfig, now) || this.$store.state.user.popPanel){
                    this.visible = true
                    this.$nextTick(()=>{
